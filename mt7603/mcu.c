...
#undef WORD
	...
	for (i = 0; i < ARRAY_SIZE(req_fields); i++) {
		...
		if(FORCE_USE_OTP_DATA){
			...
			//if(data[i].val >= 245) data[i].val = 245;

			// if(data[i].addr == 0x0035) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x0036) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x0037) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x0048) data[i].val = 0x0000; // (0)
			// if(data[i].addr == 0x0050) data[i].val = 0x0000; // (0)
			// if(data[i].addr == 0x0053) data[i].val = 0x0000; // (0)
			// if(data[i].addr == 0x0054) data[i].val = 0x0000; // (0)
			// if(data[i].addr == 0x0055) data[i].val = 0x00B2; // (178)
			// if(data[i].addr == 0x0056) data[i].val = 0x0040; // (64)
			// if(data[i].addr == 0x0057) data[i].val = 0x00C9; // (201)
			// if(data[i].addr == 0x0058) data[i].val = 0x0000; // (0)
			// if(data[i].addr == 0x0059) data[i].val = 0x0000; // (0)
			// if(data[i].addr == 0x005A) data[i].val = 0x0000; // (0)
			// if(data[i].addr == 0x005B) data[i].val = 0x0000; // (0)
			// if(data[i].addr == 0x005C) data[i].val = 0x0040; // (64)
			// if(data[i].addr == 0x005D) data[i].val = 0x00C9; // (201)
			// if(data[i].addr == 0x005E) data[i].val = 0x0000; // (0)
			// if(data[i].addr == 0x005F) data[i].val = 0x0000; // (0)
			// if(data[i].addr == 0x0060) data[i].val = 0x0000; // (0)
			// if(data[i].addr == 0x0061) data[i].val = 0x0000; // (0)
			// if(data[i].addr == 0x00A0) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x00A1) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x00A2) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x00A3) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x00A4) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x00A5) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x00A6) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x00A7) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x00A8) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x00A9) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x00AA) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x00AB) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x00AC) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x00AD) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x00C0) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x00C1) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x00C2) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x00C3) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x00C4) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x00C5) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x00C6) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x00C7) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x00C8) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x00C9) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x00CA) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x00CB) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x00CC) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x00CD) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x00CE) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x00CF) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x00D0) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x00D1) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x00D2) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x00D3) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x00D4) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x00D5) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x00D6) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x00F4) data[i].val = 0x00B8; // (184)
			// if(data[i].addr == 0x00F5) data[i].val = 0x0000; // (0)
			// if(data[i].addr == 0x00F6) data[i].val = 0x0000; // (0)
			// if(data[i].addr == 0x00F7) data[i].val = 0x0088; // (136)
			// if(data[i].addr == 0x0024) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x0025) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x0034) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x0039) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x003B) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x0042) data[i].val = 0x0000; // (0)
			// if(data[i].addr == 0x0043) data[i].val = 0x0000; // (0)
			// if(data[i].addr == 0x009E) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x009F) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x00F2) data[i].val = 0x0000; // (0)
			// if(data[i].addr == 0x00F8) data[i].val = 0x0000; // (0)
			// if(data[i].addr == 0x00F9) data[i].val = 0x0000; // (0)
			// if(data[i].addr == 0x00FA) data[i].val = 0x0000; // (0)
			// if(data[i].addr == 0x012E) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x0130) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x0131) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x0132) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x0133) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x0134) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x0135) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x0136) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x0137) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x0138) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x0139) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x013A) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x013B) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x013C) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x013D) data[i].val = 0x00FF; // (255)
			// if(data[i].addr == 0x013E) data[i].val = 0x00FF; // (255)
			...
			if(data[i].addr == 0x0035) data[i].val = 0x00FF; //0x0034; //	NIC_CONFG_01 (EXT_PA)
			...
			if(data[i].addr == 0x0042) data[i].val = 0x00FF; //	NIC_CONFG_20
			if(data[i].addr == 0x0043) data[i].val = 0x00FF; //	NIC_CONFG_21
			...
			if(data[i].addr == 0x00F4) data[i].val = 0x00B8; //0x00C0; //	XTAL_CAL
		...
		printk("[deicke] Addr: 0x%04X (req_fields[i]=0x%04X) = 0x%04X (%d)", data[i].addr, req_fields[i], data[i].val, data[i].val);
	}
	

	ret = mt76_mcu_send_msg(&dev->mt76, MCU_EXT_CMD_EFUSE_BUFFER_MODE,
				req, len, true);
	printk("[deicke] set_eeprom mcu_send_msg ret = %d", ret);
	kfree(req);
...
#undef EEP_VAL
	...
	printk("[deicke] ##################################### mt7603_mcu_set_tx_power #########################################\n");
	printk("[deicke] tx_power[0] =      %03u (0x%02X)\n", req.target_power[0], req.target_power[0]);
	printk("[deicke] tx_power[1] =      %03u (0x%02X)\n", req.target_power[1], req.target_power[1]);
	printk("[deicke] center_channel =   %03u (0x%02X)\n", req.center_channel, req.center_channel);
	printk("[deicke] tssi =             %03u (0x%02X)\n", req.tssi, req.tssi);
	printk("[deicke] temp_comp =        %03u (0x%02X)\n", req.temp_comp, req.temp_comp);
	printk("[deicke] bw_power_delta =   %03u (0x%02X)\n", req.bw_power_delta, req.bw_power_delta);
	
	for(i = 0; i < 17; i++){
		printk("[deicke] temp_comp_power[%d] =  %03u (0x%02X)\n", i, req.temp_comp_power[i], req.temp_comp_power[i]);
	}
		
	for(i = 0; i < 6; i++){
		printk("[deicke] ch_power_delta[%d] =   %03u (0x%02X)\n", i, req.ch_power_delta[i], req.ch_power_delta[i]);
	}
	for(i = 0; i < 14; i++){
